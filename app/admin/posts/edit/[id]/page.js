...
export default function EditPostPage({ params }) {
  ...
  const fetchPost = async () => {
    try {
      ...
      setFormData({
        ...
        category: data.category || 'Ekonomi Global',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { error } = await db.updatePost(params.id, postData)
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-900 mb-6">Edit Artikel</h1>
